...
var videoSourceInfoMapping = map[string]videoSourceInfo{
	...
	SourceXiGua: {
		VideoShareUrlDomain: []string{"v.ixigua.com", "www.ixigua.com", "m.ixigua.com"},
	...
	SourceWeiShi: {
		VideoShareUrlDomain: []string{"weishi.qq.com"},
	...
	SourceQuanMin: {
		VideoShareUrlDomain: []string{"xspshare.baidu.com", "quanmin.baidu.com", "quanmin.hao222.com"},
		VideoShareUrlParser: quanMin{},
		VideoIdParser:       quanMin{},
	},
	SourceHuYa: {
		VideoShareUrlDomain: []string{"v.huya.com", "www.huya.com"},
